...
class WeatherRepositoryImpl implements WeatherRepository {
  ...
  @override
  Future<Weather> getWeatherItems(
      double latitude, double longitude) async {
    final dto = await _api.getWeatherResult(latitude, longitude);

    // null처리...

    Weather resultLists = Weather(time: dto.daily!.time, maxTemp: dto.daily!.temperature2mMax, minTemp: dto.daily!.temperature2mMin, weatherCode: dto.daily!.weatherCode);
    return resultLists;
  }
}
